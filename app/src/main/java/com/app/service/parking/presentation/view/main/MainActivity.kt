package com.app.service.parking.presentation.view.main
...
import com.app.service.parking.presentation.view.favorite.FavoriteActivity
import com.app.service.parking.presentation.view.proposal.ProposalActivity
import com.app.service.parking.presentation.view.review.main.ReviewBottomSheetDialog
import com.app.service.parking.presentation.view.search.SearchActivity
...
class MainActivity : BaseActivity<ActivityMainBinding, MainViewModel>(),
    ...
    override fun onNavigationItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            ...
            R.id.menu_favorite -> {}
            R.id.menu_guide -> {}
            R.id.menu_proposal -> startActivity(Intent(this, ProposalActivity::class.java))
            R.id.menu_setting -> {}
        }
        return false
    }
