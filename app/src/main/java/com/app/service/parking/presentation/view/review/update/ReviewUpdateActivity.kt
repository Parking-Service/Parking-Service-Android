package com.app.service.parking.presentation.view.review.update
...
class ReviewUpdateActivity : BaseActivity<ActivityReviewUpdateBinding, ReviewUpdateViewModel>() {
        ...
        with(binding) {
            ...
            viewModel.reviewText.observe(this@ReviewUpdateActivity) { text ->
                ...
                reviewDoneButton.text =
                    getString(R.string.review_review_write_done_text, reviewLength) // 리뷰 내용이 변함에 따라 현재 글자수 변경
    ...
    override fun onBackPressed() {
        ...
        AlertDialog.Builder(this)
            .setTitle(getString(R.string.write_review_alert_dialog_title))
            .setMessage(getString(R.string.write_review_alert_dialog_message))
            .setPositiveButton(
